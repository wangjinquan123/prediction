...
class AdvCfg():
    ...
    def get_net_cfg(self):
        ...
        net_cfg["in_lane"] = 10
        net_cfg["in_lane_sc"] = 8  # dgf
        net_cfg["d_lane"] = 128
        net_cfg["d_decoder_F"] = 256  # dgf
        net_cfg["n_interact"] = 3  # dgf

        net_cfg["d_rpe_in"] = 5
        net_cfg["d_rpe"] = 128
        net_cfg["d_embed"] = 128
        net_cfg["d_embed_256"] = 256  # dgf
        ...
        net_cfg["D_MODEL"] = 512
        net_cfg["MAP_D_MODEL"] = 256
        net_cfg["ACTOR_D_MODEL"] = 256

        net_cfg["NUM_DECODER_LAYERS"] = 6
    ...
    def get_loss_cfg(self):
        ...
        loss_cfg["reg_coef"] = 0.7  # dgf
        loss_cfg["reg_coef_final"] = 0.2  # dgf
        loss_cfg["mgn"] = 0.2
        loss_cfg["cls_th"] = 2.0
