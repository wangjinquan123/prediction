...
class TrajPredictionEvaluator():
    ...
    def evaluate(self, post_out, data):
        ...
        for thr in thresholds:
            ...
            precision = tp / (tp + fp + 1e-8) # 10个车，6个为braids，5个预测正确，1个漏预测，3个错预测，precision=5/(5+3)=0.625    8个label
            recall = tp / (tp + fn + 1e-8)  # 10个车，6个为braids,5个预测正确，1个漏预测，3个错预测，recall=5/(5+1)=0.83
